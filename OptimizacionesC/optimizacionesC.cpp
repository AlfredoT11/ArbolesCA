...
// Versión de generación de relaciones para árboles de mundos n > 4.
int generarRelacionesArbolGrande(long long int filas, long long int columnas, py::list B, py::list S) {
    ...
    if (!datosUniverso){
        cout << "Creación de archivo de datos fallido.";
    }
    else {
        cout << "Creación del archivo de datos exitoso.";
        //datosUniverso << "Esta es una línea de prueba.";
